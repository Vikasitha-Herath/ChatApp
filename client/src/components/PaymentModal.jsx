...
export default function PaymentModal({ roomId, onSuccess, onClose }) {
  ...
  const handleDemoPayment = async () => {
    ...
    try {
      ...
      toast.success('Chat unlocked! Send unlimited messages now 🎉');
      onSuccess();
      onClose();
    } catch (err) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 w-full max-w-sm animate-fade-in shadow-2xl">
        {/* Icon */}
        <div className="text-center mb-5">
          ...
          <h2 className="text-xl font-black text-white" style={{ fontFamily: 'Syne,sans-serif' }}>Unlock Private Chat</h2>
        ...
        <div className="space-y-2">
          <button onClick={handleDemoPayment} disabled={loading}
            ...
            {loading
              ...
              : <><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>Pay &amp; Unlock Chat</>
            }
          </button>
